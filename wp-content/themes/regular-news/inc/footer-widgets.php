...
class Regular_News_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'regular_news';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'regular-news' ), $i ),
...
// Initialize.
$regular_news_footer_widgets = new Regular_News_Footer_Widgets();
