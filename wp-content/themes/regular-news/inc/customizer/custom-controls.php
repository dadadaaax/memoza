 ...
 */
class Regular_News_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__( '--None--', 'regular-news') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Regular_News_Dropdown_Category_Control extends WP_Customize_Control {
...
class Regular_News_Note_Control extends WP_Customize_Control {
...
class Regular_News_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Regular_News_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="regular_news-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Regular_News_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="regular_news-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Regular_News_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Regular_News_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="regular_news-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="regular_news-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_html( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu regular_news-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="regular_news-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Regular_News_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="regular_news-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'regular-news' ); ?>" class="regular_news-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Regular_News_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Regular_News_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
