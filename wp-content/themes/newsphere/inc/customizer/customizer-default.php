...
function newsphere_get_default_theme_options() {
    ...
    $defaults['latest_tab_title'] = __("NOWE", 'newsphere');
    $defaults['popular_tab_title'] = __("GRUBE", 'newsphere');
    $defaults['trending_tab_title'] = __("ROSNĄ", 'newsphere');
    ...
    $defaults['featured_news_section_title'] = __('KUPA MEMÓW', 'newsphere');
    ...
    $defaults['frontpage_latest_posts_section_title'] = __('ŻEBY NIE PRZEOCZYĆ', 'newsphere');
