...
function memoza_mobile_enqueue_scripts() {
    ...
    wp_enqueue_style('memozor-css', plugins_url('memozor/css/memozor.css'), array(), '1.2.1');
    wp_enqueue_script('memozor-js', plugins_url('memozor/js/memozor.js'), array('fabric-js'), '1.2.1', true);
