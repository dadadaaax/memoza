...
require_once supernews_file_directory('acmethemes/functions/sidebar-selection.php');

/*WooCommerce*/
require_once supernews_file_directory('acmethemes/woocommerce/functions-woocommerce.php');
...
require_once supernews_file_directory('acmethemes/gutenberg/gutenberg-init.php');
...
if ( is_admin() ) {
	...
	require_once supernews_file_directory('acmethemes/admin-notice/class-admin-notice-handler.php');
}
