...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.at-gsm-btn' ).click( function ( e ) {
		...
		$( this ).text( supernews_adi_install.btn_text );
		...
		$.ajax({
			...
			data: {
				...
				security : supernews_adi_install.nonce,
				...
				setTimeout(function(){
					$.ajax({
						...
						success:function( response ) {
							...
							redirect_uri         = supernews_adi_install.adminurl+'/themes.php?page=advanced-import&browse=all&at-gsm-hide-notice=welcome';
