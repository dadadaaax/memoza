...
function clean_grid_content_width() {
    $clean_grid_content_width = 716;

    if ( is_page_template( 'template-full-width-page.php' ) ) {
        $clean_grid_content_width = 1064;
    }
    ...
    $GLOBALS['content_width'] = apply_filters( 'clean_grid_content_width', $clean_grid_content_width ); /* phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedVariableFound */
}
