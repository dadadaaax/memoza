 ...
 * WooCommerce is using an older version of select2 which is conflicting with the version used by Bulk Delete.
 *
 * @see https://github.com/sudar/bulk-delete/issues/111
 * @see https://github.com/woothemes/woocommerce/issues/8766
 * @since 5.5.1
 */
function bd_deregister_woo_select2() { //phpcs:ignore
