...
define( 'NextScripts_SNAP_Version' , '4.3.18' ); define( 'NextScripts_SNAP_Version_Date' , 'Sept 4, 2020' ); require_once "inc/nxs_functions_wp.php"; if(!defined( 'NXSSNAP_BASENAME' ) ) define( 'NXSSNAP_BASENAME', plugin_basename( __FILE__ ) );
