...
* optionally, set all translations of a post sticky, supports [Polylang](https://polylang.pro) and [MultilingualPress](https://wordpress.org/plugins/multilingual-press)
