...
function memozor_enqueue_scripts() {
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'memozor_editor')) {
        ...
        wp_enqueue_style('memozor-css', plugin_dir_url(__FILE__) . 'css/memozor.css', array(), '1.2.0');
        wp_enqueue_script('memozor-js', plugin_dir_url(__FILE__) . 'js/memozor.js', array('fabric-js'), '1.2.0', true);
